...
# Building
set_environment:
	command -v emcc &> /dev/null && EXEC_ENVIRONMENT="casd" || EXEC_ENVIRONMENT=echo ${DOCKER_EXEC_ENVIRONMENT}
	touch set_environment
...
.PHONY: bench_tpch_aq
bench_tpch_aq: data bench_build
...
.PHONY: bench_tpch
bench_tpch_paper: data bench_build
	yarn workspace @duckdb/benchmarks build
...
.PHONY: bench_all
bench_all: bench_build bench_internal bench_system_sort_int bench_system_sum_csv bench_system_sort_int bench_system_regex bench_system_join_2 bench_system_join_3 data
	yarn workspace @duckdb/benchmarks bench:system:tpch:duckdb 0.1
...
bench_system_tpch_duckdb: bench_build data
	yarn workspace @duckdb/benchmarks bench:system:tpch:duckdb 0.1
...
bootstrap: submodules docker_ci_image yarn_install
	touch bootstrap
